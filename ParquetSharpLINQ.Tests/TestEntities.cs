...
/// <summary>
/// Test entity with indexed columns - for indexing/caching behavior.
/// </summary>
public class IndexedEntity
{
    [ParquetColumn("client_id", Indexed = true)]
...
public class IndexedSalesRecord
{
    ...
    [ParquetColumn("customer_id", Indexed = true)] public long CustomerId { get; set; }
    ...
    [ParquetColumn("year", IsPartition = true)] public int Year { get; set; }

    [ParquetColumn("month", IsPartition = true)] public int Month { get; set; }

    [ParquetColumn("region", IsPartition = true)] public string Region { get; set; } = string.Empty;
}
